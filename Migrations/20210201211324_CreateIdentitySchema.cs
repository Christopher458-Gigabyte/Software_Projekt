        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProgrammverantwortlichenId = table.Column<int>(nullable: false),
                    ModulverantwortlichenId = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModulverantwortlichenId = table.Column<int>(nullable: false),
                    ModulverantwortlicheR = table.Column<string>(nullable: true),
                    Semester = table.Column<int>(nullable: true),
                    WorkloadH = table.Column<int>(nullable: true),
                    Semesterwochenstunden = table.Column<int>(nullable: true),
                    Credits = table.Column<int>(nullable: false),
                    Turnus = table.Column<string>(nullable: true),
                    CuriculareZuordnung = table.Column<string>(nullable: true),
                    Lernziele = table.Column<string>(nullable: true),
                    Schlüsselqualifikationen = table.Column<string>(nullable: true),
                    InhaltilicheBeschreibung = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModulverantwortlicheR", x => x.ModulverantwortlichenId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonModel", x => x.FirstName);
                });

            migrationBuilder.CreateTable(
                name: "ProgrammverantwortlicheR",
                columns: table => new
                {
                    ProgrammverantwortlichenId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProgrammverantwortlicheR", x => x.ProgrammverantwortlichenId);
                });
